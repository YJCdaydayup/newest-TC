...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    cell.textLabel.font = [UIFont systemFontOfSize:14*S6];
...
- (void)showBlowView:(UIView * __nonnull)view
{
    ...
    self.bgView.frame = CGRectMake(0, 0, Wscreen, Hscreen);
    ...
    if (_Size.width == 0 && _Size.height == 0) {
        ...
        frameToScreen.size.height = Hscreen * 0.5;
    ...
    if (CGRectGetMaxY(frameToScreen) > Hscreen) {
