...
- (void)shake {
    [self shakeWithOptions:SCShakeOptionsDirectionRotate force:kDefaultShakeForce duration:kDefaultShakeDuration iterationDuration:kDefaultShakeIterationDuration completionHandler:nil];
}
